...
sealed class UpdateChannelOption(
    ...
    data object Stable : UpdateChannelOption(0, "稳定版") {
        override val url = "https://registry.npmmirror.com/@windyy/myg-app/latest/files/dist/stable.json"
    }

    data object Beta : UpdateChannelOption(1, "测试版") {
        override val url = "https://registry.npmmirror.com/@windyy/myg-app/latest/files/dist/beta.json"
    }
